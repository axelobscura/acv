            ...
            <div className="p-0 w-full">
                ...
                <form>
                    ...
                    <div className='etapaA2' style={{
                        ...
                        <input type="text" ref={A2_1} name='A2_1' placeholder={value_A2_1 ? value_A2_1 : 'La ubicación del proveedor de materia prima'} className="font-orbitron border border-gray-300 rounded-md px-4 py-2 text-gray-900 focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-full"></input>
                        ...
                        <input type="number" ref={A2_2} name='A2_2' placeholder={value_A2_2 ? value_A2_2 : 'Los km que el proveedor recorre de ida'} className="font-orbitron border border-gray-300 rounded-md px-4 py-2 text-gray-900 focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-full"></input>
                        ...
                        <input type="number" ref={A2_3} name='A2_3' placeholder={value_A2_3 ? value_A2_3 : 'Los km que el proveedor recorre de regreso'} className="font-orbitron border border-gray-300 rounded-md px-4 py-2 text-gray-900 focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-full"></input>
                        ...
                        <input type="text" ref={A2_4} name='A2_4' placeholder={value_A2_4 ? value_A2_4 : 'El rendimiento de la unidad de transporte llena'} className="font-orbitron border border-gray-300 rounded-md px-4 py-2 text-gray-900 focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-full"></input>
                        ...
                        <input type="text" ref={A2_5} name='A2_5' placeholder={value_A2_5 ? value_A2_5 : 'El rendimiento de la unidad de transporte vacía'} className="font-orbitron border border-gray-300 rounded-md px-4 py-2 text-gray-900 focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-full"></input>
                    ...
                    <div className='etapa A3' style={{
                        ...
                        <input type="number" ref={A3_1} name='A3_1' placeholder={value_A3_1 ? value_A3_1 : 'Consumo total de energía eléctrica en kWh'} className="font-orbitron border border-gray-300 rounded-md px-4 py-2 text-gray-900 focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-full"></input>
                        ...
                        <input type="text" ref={A3_2} name='A3_2' placeholder={value_A3_2 ? value_A3_2 : 'Consumo de combustibles fósiles en la planta'} className="font-orbitron border border-gray-300 rounded-md px-4 py-2 text-gray-900 focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-full"></input>
                        ...
                        <input type="number" ref={A3_3} name='A3_3' placeholder={value_A3_3 ? value_A3_3 : 'Consumo de combustibles fósiles en las unidades móviles de la empresa'} className="font-orbitron border border-gray-300 rounded-md px-4 py-2 text-gray-900 focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-full"></input>
                        <div className='flex w-full justify-end mt-2'>
