...
export default function Login(checkUser:any) {
    return(
        <div className='p-3 text-center'>
            ...
            <form onSubmit={() => checkUser()}>
                <div className="mb-2">
                    ...
                    <input type="text" className="bg-green-50 border border-green-500 text-green-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500" placeholder="Ingrese su nombre de usuario" />
                </div>
                <div className="mb-2">
                    <label className="font-orbitron block mb-2 text-sm font-medium text-gray-100 dark:text-gray-100 text-left">Contraseña:</label>
                    <input type="password" className="bg-green-50 border border-green-500 text-green-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500" placeholder="Ingrese su contraseña" />
                </div>
